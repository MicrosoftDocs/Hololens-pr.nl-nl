...
[Beleids-CSP: Bijwerken](/windows/client-management/mdm/policy-csp-update) definieert de beleidsregels die Windows Update voor Bedrijven configureren.
...
Hier wordt de voortgang van de implementatie in de tijd naar de hele organisatie uitgevoerd.
...
Windows Holographic heeft versie [21H1](hololens-release-notes.md#windows-holographic-version-21h1) een vroege preview ingeschakeld voor delivery optimization-instellingen om het bandbreedteverbruik voor downloads van meerdere apparaten HoloLens beperken. U kunt hier een volledige beschrijving van deze functionaliteit en de aanbevolen netwerkconfiguratie vinden: [Delivery Optimization voor Windows 10 updates.](/windows/deployment/update/waas-delivery-optimization)
...
### <a name="revert-to-a-previous-version-hololens-1st-gen"></a>Terugkeren naar een vorige versie (HoloLens (eerste generatie))
...
1. Gebruik de micro-USB-kabel die samen met uw HoloLens apparaat is geleverd om uw HoloLens te verbinden met uw computer. Zelfs als u andere kabels hebt gebruikt om uw apparaat HoloLens verbinden, werkt deze het beste.
...
Als WDRT uw apparaat niet detecteert HoloLens, start u de computer opnieuw op. Als dat niet werkt, selecteert u Mijn apparaat is niet **gedetecteerd,** selecteert **Microsoft HoloLens** en volgt u de instructies.
