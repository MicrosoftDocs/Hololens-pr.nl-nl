...
ms.locfileid: "114991420"
---
# <a name="manage-user-identity-and-sign-in-for-hololens"></a>Gebruikersidentiteit en aanmelding beheren voor HoloLens

> [!NOTE]
> Dit artikel is een technische naslag voor IT-professionals en technische professionals. Als u op zoek bent naar HoloLens instellen, leest u '[Uw HoloLens (eerste generatie)](hololens1-start.md)instellen' of['Uw](hololens2-start.md)HoloLens 2 instellen'.
...
Standaard moet u zich, net Windows 10 andere apparaten, opnieuw aanmelden wanneer HoloLens wordt opgestart of wordt hervat vanuit de stand-by. U kunt de Instellingen-app gebruiken om dit gedrag te wijzigen, of het gedrag kan worden bepaald door groepsbeleid.
