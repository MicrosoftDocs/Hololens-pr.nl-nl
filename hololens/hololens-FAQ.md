...
description: Hebt u een snelle vraag over het HoloLens of interactie met hologrammen?  Dit artikel bevat een snel antwoord en meer resources.
...
ms.locfileid: "126032212"
---
# <a name="holograms-and-interactions-troubleshooting"></a>Hologrammen en interacties oplossen

In dit artikel worden problemen opgelost met het plaatsen van hologrammen, het werken met ruimten en het melden van problemen met hologrammen.
...
Zie Aanpassen voor tips over het gebruik [](hololens2-setup.md#adjust-fit)van HoloLens.
...
Als uw HoloLens de ruimte die u in zich hebt niet automatisch kan identificeren en laden, controleert u de volgende factoren:
...
Als u nog steeds problemen hebt, kunt u de kalibratie-app uitvoeren. Deze app kalibreert uw HoloLens om ervoor te zorgen dat uw hologrammen er op hun best uitzien. Ga hiervoor naar Instellingen  >  **System**  >  **Utilities**. Selecteer **onder Kalibratie** de **optie Kalibratie openen.**
...
- Zorg ervoor dat u een sterk Wi-Fi signaal hebt. Als u een nieuwe omgeving met geen Wi-Fi of een zwak Wi-Fi signaal, HoloLens u uw ruimte niet vinden. Controleer uw Wi-Fi door naar Instellingen  >  **Network &amp; Internet**  >  **Wi-Fi te gaan.**
...
Als u de hologrammen die u hebt geplaatst niet ziet of als u een aantal dat u niet verwacht ziet, kunt u een of meer van de volgende oplossingen proberen:
...
Als HoloLens uw ruimte niet kunt in kaart brengen of laden, wordt de beperkte modus gebruikt en kunt u geen hologrammen plaatsen of hologrammen zien die u hebt geplaatst. U kunt het volgende proberen:
...
- Als het probleem zich blijft voordoen, moet u de app Kalibratie uitvoeren. U vindt deze in **Instellingen**  >  **System**  >  **Utilities**.
...
1. Haal de nieuwste hologramschaal- en stabiliteitsfixes op door bij te werken naar de nieuwste [Windows Holographic OS, (20H2 of hoger).](hololens-release-notes.md#windows-holographic-version-20h2) Voer na het bijwerken het volgende uit:
    ...
    1. Maak een nieuwe kaart van uw ruimte door de ruimte HoloLens en rond uw kamer te lopen en alle gebieden en oppervlakken in de ruimte te bekijken. Doe dit 2-3 minuten.
