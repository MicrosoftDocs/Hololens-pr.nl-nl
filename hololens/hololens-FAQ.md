...
---
# <a name="holograms-and-interactions-troubleshooting"></a>Problemen met hologrammen en interacties oplossen
...
- Probeer [deze opnieuw op te starten](hololens-restart-recover.md) om te zien of dit problemen verhelpt.
- Voordat u problemen gaat oplossen, moet u ervoor zorgen dat de HoloLens in rekening worden [gebracht](hololens2-charging.md) (minimaal een uur in rekening gebracht). 
...
Zie Aanpassen aanpassen voor tips over [](hololens2-setup.md#adjust-fit)het dragen van uw HoloLens.
...
- [Hologrammen zien er niet goed uit of verplaatsen zich](#holograms-dont-look-right-or-are-moving-around)
...
- [Hologrammen worden aan de andere kant van een wand weergegeven](#holograms-are-appearing-on-the-other-side-of-a-wall)
...
## <a name="holograms-dont-look-right-or-are-moving-around"></a>Hologrammen zien er niet goed uit of verplaatsen zich

Als uw hologrammen er niet goed uitzien (ze zijn bijvoorbeeld jitter of shaky, of als er zwarte patches op staan), probeert u een van deze oplossingen:
...
- Probeer rond te lopen en naar uw omgeving te kijken, zodat HoloLens ze vollediger kan scannen.
- Als u veel hologrammen hebt geplaatst, kunt u proberen een aantal te verwijderen.

Als u nog steeds problemen hebt, probeert u de app Kalibratie uit te proberen. Deze app kalibreert uw HoloLens om ervoor te zorgen dat uw hologrammen er op hun best uitzien. Ga hiervoor naar Instellingen  >  **Systeemprogramma's.**  >   Selecteer **onder Kalibratie** de **optie Kalibratie openen.**
...
- Zorg ervoor dat u een sterk signaal Wi-Fi geven. Als u een nieuwe omgeving met geen Wi-Fi of een zwak Wi-Fi signaal, kan HoloLens uw ruimte niet vinden. Controleer uw Wi-Fi verbinding door naar **Instellingen**  >  **&amp; Netwerkinternet**  >  **Wi-Fi te gaan.**
...
- Verwijder hologrammen die u niet nodig hebt door naar Settings  >  **System**  >  **Holograms**  >  **Remove nearby holograms te gaan.** Of selecteer indien nodig **Alle hologrammen verwijderen.**
...
- Door de ruimten lopen zodat HoloLens uw omgeving opnieuw kan scannen. Als u wilt zien wat er al is gescand, tikt u in de lucht om de mesh-afbeelding van de toewijzing weer te brengen.
- Als u een nieuwe ruimte wilt maken, maakt u verbinding met Wi-Fi en start u de HoloLens opnieuw.
...
Hologrammen kunnen ook worden geblokkeerd of ingepakt door andere hologrammen of door objecten zoals muren. Als dit gebeurt, probeert u een van de volgende oplossingen:
...
## <a name="holograms-are-appearing-on-the-other-side-of-a-wall"></a>Hologrammen worden aan de andere kant van een wand weergegeven

Als u dicht bij een wand bent of als HoloLens de wand nog niet heeft gescand, ziet u hologrammen in de volgende ruimte. Als u de wand wilt scannen, moet u tussen één en drie meter van de wand staan en naar de wand staren.

Een zwart of reflectief object (bijvoorbeeld een zwarte bank of een koelkast) in de buurt van de wand kan problemen veroorzaken wanneer HoloLens de wand scant. Als er een dergelijk object is, scant u de andere kant van de wand.
...
Een hologram dat u op een wand zet, lijkt meestal een inch of zo van de wand verwijderd te zijn. Als deze verder weg lijkt te zijn, probeert u een of meer van de volgende oplossingen:
...
- Als het probleem zich blijft voordoen, moet u de app Kalibratie uitvoeren. U vindt deze in **Instellingen**  >    >  **Systeemprogramma's.**
...
1. Haal de nieuwste hologramschaal- en stabiliteitsfixes op door bij te werken naar het nieuwste [Windows Holographic-besturingssysteem (20H2 of hoger).](hololens-release-notes.md#windows-holographic-version-20h2) Voer na het bijwerken het volgende uit:
    ...
    1. Maak een nieuwe kaart van uw ruimte door de HoloLens te dragen en rond uw kamer te lopen en alle gebieden en oppervlakken in de ruimte te bekijken. Doe dit 2-3 minuten.
...
1. Als het probleem niet wordt opgelost door bij te werken, kunt u een [Feedback-hub indienen.](hololens-feedback.md) Nadat u feedback hebt ingevuld,  kunt u de knop Delen gebruiken om een eenvoudig te delen koppeling te maken die kan worden verzonden wanneer contact wordt opgenomen met de ondersteuning.
