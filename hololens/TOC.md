...
#### [Gebruik uw stem om uw stem te HoloLens](hololens-cortana.md)
...
#### [Nieuwe Microsoft Edge](hololens-new-edge.md)
### Toepassingen beheren
#### [Store-apps zoeken, installeren en verwijderen](holographic-store-apps.md)
...
#### [Verbinding maken naar Bluetooth USB-C-apparaten](hololens-connect-devices.md)
...
### [Uw HoloLens met meerdere personen delen](hololens-multiple-users.md)
## Beveiliging
...
### [HoloLens 2 Privacy en gegevensbescherming](hololens2-privacy.md)
## Apparaatregistratie
### [HoloLens registreren bij MDM](hololens-enroll-mdm.md)
### [Windows Autopilot voor HoloLens 2](hololens2-autopilot.md) 
### [Registreren in een omgeving met beperkte MACWi-Fi adressen](mac-address-options.md)
...
### [MDM gebruiken voor het beheren van HoloLens apparaten](hololens-mdm-configure.md)
...
### [HoloLens Kioskreferentiegegevens](hololens-kiosk-reference.md)
...
# Problemen oplossen
## [Apparaat](hololens-troubleshooting.md)
## [Hologrammen en interacties](hololens-faq.md)
## [Weergave](hololens2-display.md)
## [Implementatie en beheerde apparaten](hololens2-enterprise-troubleshooting.md#)
## [Diagnostische logboeken inschakelen](hololens-diagnostic-logs.md)
## [Opnieuw opstarten, opnieuw instellen of HoloLens 2](hololens-recovery.md)
...
## [Meer informatie over Microsoft Mesh (preview)](/mesh/overview)
...
#### [Opnieuw opstarten, opnieuw instellen of HoloLens herstellen (1e generatie)](hololens1-recovery.md)
### HoloLens (eerste generatie) Beveiliging
#### [Veelgestelde HoloLens (eerste generatie) Beveiligingsvragen](hololens1-faq-security.yml)
