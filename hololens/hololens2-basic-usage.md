...
1. Pak het hologram door uw wijsvinger en duim op het hologram te knijpen of uw hand omlaag te kijken en uw oren er vervolgens overheen te doen.  Pak een 3D-hologram ergens in het blauwe begrensingsvak.  Haal voor een app-venster de titelbalk op.
...
Pak de grepen van **het grepen** die worden weergegeven in de hoeken van 3D hologrammen en app-vensters, en gebruik deze om de grepen te grepen.

Wanneer de grootte van een app-venster op deze manier wordt vergroot, neemt de inhoud van het venster overeenkomstig toe en is deze gemakkelijker te lezen.

Als u de inhoud van een  app-venster zo wilt dat er meer inhoud in het venster wordt weergegeven, gebruikt u de grepen voor het grepen voor het iseren van de inhoud aan de zijkanten en onderranden van het app-venster.

Er zijn twee manieren om het aantal hologrammen dat verder van u is verwijderd, te veranderen. U kunt twee hoeken van het hologram pakken of de besturingselementen voor het resize gebruiken.

### <a name="rotating-holograms"></a>Hologrammen roteren

Voor 3D-hologrammen kunt u de grepen die op de verticale randen van het begrensingsvak worden weergegeven, vastpakken en gebruiken.

Voor app-vensters zorgt het verplaatsen van een app-venster ervoor dat het automatisch draait en u wordt geconfronteerd.
...
- Beweeg uw handen steeds dichter bij uw hoofd om het hologram te draaien.
...
U kunt uw stem gebruiken om de meeste dingen te doen die u ook doet met hands on HoloLens, zoals het maken van een snelle foto of het openen van een app.
