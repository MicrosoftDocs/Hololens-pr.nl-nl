...
1. Kalibreer HoloLens uw ogen.  Als u ervoor kiest om kalibratie over te slaan, wordt u de volgende keer dat u zich aanmeldt gevraagd. 
...
1. Selecteer uw telemetrieniveau. Schakel desgewenst Optionele telemetrie in. Deze informatie helpt het technische HoloLens echt.

    <img src="images/24-telemetry.png" width="500px" alt="Telemetry level">


1. Meer informatie over het gebruik van het beginbewegingen op HoloLens 2.
