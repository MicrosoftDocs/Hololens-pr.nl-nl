...
---
# <a name="hololens-environment-considerations"></a>Overwegingen voor de HoloLens-omgeving

HoloLens combineert het holografische met de 'echte' wereld en plaatst hologrammen in uw omgeving. Een holografische app-venster 'hangt' aan de wand, een holografische man draait op de tabletop, de oren van een vriend zitten op het hoofd van uw onbewuste vriend. Wanneer u een immersive game of app gebruikt, wordt de holografische wereld verspreid om uw omgeving te vullen, maar u kunt de ruimte nog steeds zien en verplaatsen.
...
HoloLens-apparaten weten hoe ze stabiele en nauwkeurige hologrammen kunnen plaatsen door *gebruikers* in een ruimte bij te houden. Zonder de juiste tracering begrijpt het apparaat niet de omgeving of de gebruiker in het apparaat. Hologrammen kunnen op de verkeerde plaatsen worden weergegeven, niet elke keer op dezelfde plek worden weergegeven of helemaal niet worden weergegeven. De gegevens die worden gebruikt om gebruikers bij te houden, worden weergegeven in de *ruimtelijke kaart*.  

De traceringsprestaties worden sterk beïnvloed door de omgeving waarin de gebruiker zich in de omgeving zich voordeed. Het afstemmen van een omgeving om stabiele en consistente tracering te stimuleren, is een kunst in plaats van een wetenschap. Veel verschillende omgevingsfactoren worden samengevoegd om tracering mogelijk te maken, maar als Mixed Reality-ontwikkelaar zijn er verschillende factoren waarmee u rekening kunt houden om ruimte voor betere tracering af te stemmen.

### <a name="lighting"></a>Belichting

Windows Mixed Reality gebruikt visueel licht om de locatie van de gebruiker bij te houden. Wanneer een omgeving te licht is, kunnen de camera's verzadigd raken en wordt er niets gezien. Als de omgeving te donker is, kunnen de camera's onvoldoende informatie ophalen en wordt er niets gezien. De belichting moet even zijn en voldoende licht zijn dat een mens zonder moeite kan zien, maar niet zo licht dat het licht erg is om naar te kijken.  
...
Als u eenmeter hebt, is een stabiele 500-1000 kb een goede plek om te beginnen.  

#### <a name="types-of-lighting"></a>Soorten belichting

Verschillende soorten licht in een ruimte kunnen ook van invloed zijn op het bijhouden. Licht pulseer met de elektriciteit van de wisselstroom die er doorheen loopt: als de AC-frequentie 50 Hz is, wordt de lichte pulses op 50 Hz gebruikt. Voor een mens is dit niet opgemerkt. De 30-camera van HoloLens ziet deze wijzigingen echter: sommige frames zullen goed worden gebruikt, sommige zullen slecht worden aanlicht en andere worden oververlicht wanneer de camera probeert te compenseren voor lichte pulses.  

In de Verenigde Staten is de standaard voor de elektriciteitsfrequentie 60 Hz, dus de gloeilamp pulses worden gebruikt met de framesnelheid van HoloLens: 60 Hz-pulses die zijn afgestemd op de 30 FPS-framesnelheid van HoloLens. Veel landen hebben echter een AC-frequentiestandaard van 50 Hz, wat betekent dat sommige HoloLens-frames worden gebruikt tijdens de pulses en andere niet. Het is met name bekend dat de belichting in Europa problemen veroorzaakt.  
...
Gebruik daarnaast unieke functies in dezelfde ruimte. Dezelfde poster die meerdere keren over een wand wordt herhaald, veroorzaakt bijvoorbeeld verwarring bij het apparaat, omdat de HoloLens niet weet naar welke van de terugkerende posters het gaat. Een veelgebruikte manier om unieke functies toe te voegen, is het gebruik van regels maskeringstape om unieke, niet-terugkerende patronen te maken langs de muren en de vloer van een ruimte.  

Een goede vraag om uzelf te stellen is: als u slechts een klein deel van de scène hebt gezien, kunt u zichzelf dan uniek in de ruimte vinden? Zo niet, dan heeft het apparaat waarschijnlijk ook problemen met het bijhouden van de gegevens.
...
### <a name="wi-fi-fingerprint-considerations"></a>Wi-Fi vingerafdruk
...
Netwerkidentificatie (zoals SSID of MAC-adres) wordt niet naar Microsoft verzonden en alle Wi-Fi blijven lokaal op de HoloLens.

## <a name="mapping-new-spaces"></a>Nieuwe ruimten toewijzen

Wanneer u een nieuwe ruimte opslaat (of een bestaande laadt), ziet u een mesh-afbeelding die over de ruimte verspreidt. Dit betekent dat uw apparaat uw omgeving toewijst. Een HoloLens leert een ruimte in de tijd, maar er zijn tips en trucs voor het in kaart brengen van ruimten.

## <a name="environment-management"></a>Omgevingsbeheer

Er zijn twee instellingen waarmee gebruikers hologrammen kunnen 'ops schonen' en ervoor zorgen dat HoloLens een ruimte 'vergeet'. Ze bestaan in **Hologrammen en omgevingen** in de instellingen-app. De tweede instelling wordt ook weergegeven onder **Privacy** in de instellingen-app.  

1. **Verwijder hologrammen in de buurt.** Wanneer u deze instelling selecteert, wist HoloLens alle anker hologrammen en alle opgeslagen kaartgegevens voor de 'huidige ruimte' waar het apparaat zich bevindt. Er wordt een nieuwe kaartsectie gemaakt en opgeslagen in de database voor die locatie zodra hologrammen opnieuw in dezelfde ruimte worden geplaatst.

1. **Verwijder alle hologrammen.** Door deze instelling te selecteren, wist HoloLens ALLE kaartgegevens en anker hologrammen in de volledige databases van ruimten. Er worden geen hologrammen opnieuw ontdekt en hologrammen moeten opnieuw worden geplaatst om mapsecties in de database op te slaan.
...
Om uw [hologrammen](/windows/mixed-reality/hologram) er helder, helder en stabiel uit te laten zien, moet uw HoloLens alleen voor u worden ge kalibreerd. Wanneer u uw HoloLens voor het eerst in stelt, wordt u door dit proces geleid. Als hologrammen er later niet goed uitzien of als u talloze fouten ziet, kunt u aanpassingen aanbrengen.
...
Als uw hologrammen er jittery of shaky uitzien, of als u problemen hebt bij het plaatsen van hologrammen, is het eerste wat u moet proberen de [kalibratie-app](hololens-calibration.md). Deze app kan ook helpen als u last hebt van eventuele problemen tijdens het gebruik van uw HoloLens.
...
Als iemand anders uw HoloLens gaat gebruiken, moet hij eerst de kalibratie-app uitvoeren, zodat het apparaat goed voor hem of haar is ingesteld.

## <a name="temperature-and-regulatory-information"></a>Informatie over temperatuur en regelgeving

[Informatie over HoloLens-regelgeving:](https://support.microsoft.com/en-us/help/13761/hololens-regulatory-information)bevat informatie over temperatuurbereik, verwijdering, radio- en tv-interferentie en meer.

Zie Details voor HoloLens in [Materialen](https://www.microsoft.com/legal/compliance/materials-substances) en stoffen > REACH Article 33 Disclosure on Environmental Compliance (PDF).
...
1. Het apparaat in de schaduw gebruiken; zelfs binnen wordt directe stenage door vensters of skylights vermeden.
1. Als u de bovenstaande richtlijnen volgt, maar onverwachte problemen ervaart, controleert u of Volledige/optionele telemetrie is ingeschakeld voordat u [Feedback indient.](hololens-feedback.md) Volledige/optionele telemetrie is vereist voor het onderzoeken van eventuele opschatbare problemen.
