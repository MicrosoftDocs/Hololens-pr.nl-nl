...
- [Apparaatportal-out voor het uploaden/downloaden van bestanden](#device-portal-file-uploaddownload-times-out)
...
- Schakel uw HoloLens door op de aan/uit-knop te drukken totdat alle vijf de LED's zichzelf uitschakelen of 15 seconden lang als de LED's niet reageren. Als u uw HoloLens, drukt u opnieuw op de aan/uit-knop.

Als deze stappen niet werken, [](hololens-recovery.md) kunt u proberen uw apparaat HoloLens 2 of HoloLens [(1e generatie) te herstellen.](hololens1-recovery.md)
...
- Bepaalde soorten contactlenzen en bril (gekleurde contactlenzen, sommige tor-contactlenzen, IR-blokkerende bril, een bril met hoge bril, zonnebrillen of iets dergelijks)
...
Als uw HoloLens 2 niet reageert op uw stem, moet u ervoor zorgen dat Spraakherkenning is ingeschakeld. Ga naar **Start**  >  **Instellingen**  >  **Privacy**  >  **Speech** en schakel **Spraakherkenning in.**
...
- Op HoloLens 2 wordt een cursor met de hand weergegeven wanneer uw hand zich in de buurt van een slate beweegt en er een hand ray wordt weergegeven wanneer de slates verder weg zijn
...
U kunt andere BLUETOOTH- en GATT-apparaten koppelen aan uw HoloLens. Mogelijk moet u echter bijbehorende companion-apps installeren van Microsoft Store om de apparaten daadwerkelijk te kunnen gebruiken.
