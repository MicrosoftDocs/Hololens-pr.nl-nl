...
Als u de update niet kunt Remote Assist naar een nieuwere build, kunt u de volgende stappen volgen.

#### <a name="restart-in-between-calls"></a>Opnieuw opstarten tussen aanroepen

Als uw aanroepen langer dan 20 minuten duren en u dit probleem ondervindt, start u het apparaat opnieuw op. Als u het apparaat opnieuw opstart tussen Remote Assist, wordt uw apparaat vernieuwd en weer in een goede staat gezet.
...
Er is een probleem tijdens OOBE, waarbij wanneer de gebruiker een werk- of schoolaccount heeft gekozen en zijn of haar wachtwoord inschakelt, het proberen om over te schakelen naar de speciale tekens op het toetsenbord door op de knop &123 te tikken, niet wordt gewijzigd in speciale tekens. Dit is een **bekend probleem.**
...
- Als u alleen getallen intoetst, kan een gebruiker op bepaalde sleutels drukken en deze in de hand houden om een uit uitgebreid menu te openen.
...
- Verwijder enkele ongebruikte ruimten. Ga naar **Instellingen**  >  **Systeemruimten,** selecteer een spatie die u niet meer nodig hebt en selecteer vervolgens  >   **Verwijderen.**
...
- Bepaalde typen contactlenzen en bril (gekleurde contactlenzen, sommige metrische contactlenzen, IR-blokkerende bril, een bril met hoge bril, zonnebrillen of iets dergelijks)
- Meer uitgesproken spreekuitbreidingen en een aantal eyelash-extensies
...
Als Cortana niet reageert op uw spraakopdrachten, moet u ervoor zorgen Cortana is ingeschakeld. Selecteer in Alle apps lijst de optie **Cortana**  >  **Menu**  >  **Notebook**  >  **Instellingen** om wijzigingen aan te brengen. Zie Uw stem gebruiken met HoloLens voor meer informatie [over wat u kunt HoloLens.](hololens-cortana.md)
...
- Bluetooth mice.
- Klik [HoloLens op](hololens1-clicker.md).
