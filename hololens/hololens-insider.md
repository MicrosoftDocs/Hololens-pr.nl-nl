...
|-------------------------|----------------------------|--------------|------------------|
| [Platformmodus verplaatsen](#moving-platform-mode) | Introduceert de bètaversie van de Moving Platform-modus, die, wanneer deze is geconfigureerd, het gebruik van HoloLens 2 mogelijk maakt op grote zeepaden die te maken hebben met een laag dynamische beweging. | Alles | 20348.1411 |
...
✔️ Als u de vrije opslagruimte, SSID of BSSID van uw HoloLens wilt weten, raadpleegt u deze [rapportage-CSP's.](#csp-changes-for-reporting-hololens-details) <br>
...
1. [Schakel de ontwikkelaarsmodus en de apparaatportal in.](/mixed-reality/develop/platform-capabilities-and-apis/using-the-windows-device-portal)
...
Het beleid RequirePrivateStoreOnly is ingeschakeld voor HoloLens. Met dit beleid kan de Microsoft Store-app zodanig worden geconfigureerd dat alleen de persoonlijke opslag wordt weer te geven die voor uw organisatie is geconfigureerd. Beperk de toegang tot alleen de apps die u beschikbaar hebt gemaakt.
...
- Er is een [API](/uwp/api/windows.system.userprofile.assignedaccesssettings?view=winrt-20348&preserve-view=true) voor toegewezen toegang ingeschakeld, zodat apps nu kunnen bepalen of een HoloLens wordt uitgevoerd in de kioskmodus voor de gebruiker die is aangemeld bij de HoloLens.
...
#### <a name="stage-one---release-preview"></a>Fase 1 - releasepreview
