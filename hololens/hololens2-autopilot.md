...
Vanaf Windows Holographic-versie 2004 ondersteunt HoloLens 2 de Windows [Autopilot-modus](/mem/autopilot/self-deploying) voor zelf implementeren met Microsoft Intune (MDM's van derden worden niet ondersteund). Deze configuratie vermindert de overhead voor voorraadbeheer, de kosten voor de voorbereiding van een praktijkapparaat en ondersteuningsoproepen van werknemers tijdens de installatie. Meer informatie in de [Windows Autopilot-documentatie.](/mem/autopilot/windows-autopilot)
...
Nadat de bovenstaande instructies zijn voltooid, HoloLens 2 uw gebruikers de volgende ervaring om hun apparaten HoloLens inrichten:  
