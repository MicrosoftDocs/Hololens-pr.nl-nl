...
### <a name="onedrive-for-work-or-school-camera-roll-upload"></a>OneDrive het uploaden van camera's voor werk of school
...
>
> Met de introductie van Windows Holographic-versie 21H1 worden maandelijkse onderhoudsupdates voor Windows **Holographic-versie 1903.** Hierdoor kunnen we ons richten op recentere releases en waardevolle verbeteringen blijven leveren.
...
[Aan/uit-menu vanaf het startmenu](#power-menu-from-start) | Start in het menu Start het apparaat opnieuw en sluit HoloLens af. | Eindgebruiker |
...
> [!IMPORTANT]
> Vanwege het grote aantal browserbeleidsregels dat door de nieuwe Microsoft Edge wordt ondersteund, kan ons team niet garanderen dat elk nieuw beleid op deze HoloLens 2. We hebben echter getest en bevestigd dat het nieuwe Microsoft Edge equivalent van elk verouderd Microsoft Edge-beleid dat eerder werd ondersteund op HoloLens 2 werken zoals verwacht. Zie Microsoft Edge (oudere versie) voor [Microsoft Edge-toewijzing](/deployedge/microsoft-edge-policy-map-legacy-to-newedge) van beleid om het nieuwe Microsoft Edge-equivalent te vinden van elk verouderd Microsoft Edge-browserbeleid dat u gebruikte met HoloLens 2.
>
...
- Instellingen zoeken: zoek naar instellingen op de Instellingen startpagina met trefwoorden of de naam van de instelling.
- System > Sound:
...
Sommige klanten vinden het sneller 'typen' op virtuele toetsenborden door de vorm te vegen van het woord dat ze willen typen. We bekijken deze functie voor het holografische toetsenbord. U kunt met één woord tegelijk vegen door de punt van uw vinger door te geven via het vlak van het holografische toetsenbord, de vorm van het woord te vegen en vervolgens de punt van uw vinger uit het vlak van het toetsenbord te halen. U kunt vervolgwoorden swipen zonder dat u op de spatiebalk hoeft te drukken door uw vinger tussen woorden van het toetsenbord te verwijderen. U weet dat de functie werkt als u een veegtrail ziet na de beweging van uw vinger op het toetsenbord.
...
Vóór deze release moesten gebruikers het inrichtingsscherm handmatig starten tijdens OOBE om in te delen met behulp van een knopcombinatie. Gebruikers kunnen nu de combinatie van knoppen overslaan met behulp van een inrichtingspakket op een USB-opslagstation. 
...
#### <a name="what-would-happen-during-oobe-if-autopilot-profile-is-unassigned-on-a-hololens-after-tenantlockdown-was-set-to-true"></a>Wat gebeurt er tijdens OOBE als het Autopilot-profiel niet is toegewezen aan een HoloLens nadat TenantLockdown is ingesteld op true? 
...
Eerder werden er fouten ondervonden bij het toepassen van de kioskmodus, HoloLens gebruikt om alle toepassingen weer te geven in het menu Start. In Windows Holographic-versie 20H2 in geval van fouten worden er geen apps weergegeven in het menu Start, zoals hieronder wordt weergegeven: 
...
Er mixed reality nieuwe beleidsregels gemaakt voor HoloLens 2 apparaten op Windows Holographic-versie 20H2. Nieuwe beheersbare instellingen zijn: helderheid instellen, volume instellen, audio-opname uitschakelen in mixed reality-opnamen, instellen wanneer diagnostische gegevens kunnen worden verzameld en AAD-groepslidmaatschapcache.  
...
Nieuw ingeschakeld beleid waarmee meer beheeropties van HoloLens 2 ingeschakeld. 
...
-   Naast sensoren die worden blootgesteld in de HoloLens (1e generatie) Onderzoeksmodus, bieden we nu IMU-sensortoegang, waaronder een versnellingsmeter, eenscope en een teller.
...
- Meer informatie: inhoud moet online naar de meest recente privacyverklaring wijzen.
...
- Op de Windows Mixed Reality apparaten is de vector voor de voorwaartse richting parallel aan de grond wanneer het hoofd van de gebruiker zich in een neutrale positie in de toekomst in een neutrale positie bemaakt. Eerdere versies van HoloLens 2 echter de vector uitgelijnd om in plaats daarvan haaks op de weergavepanelen te staan, die een paar graden omlaag wordt gedraaid ten opzichte van de ideale richting. Nieuwere versies van HoloLens 2 hebben dit gecorrigeerd om semantische consistentie tussen formulierfactoren te garanderen.
...
*Neem contact op met uw accountmanager om nu deel te nemen aan de AutoPilot-preview. Apparaten die gereed zijn voor Autopilot worden binnenkort weer in gebruik.*
...
- Een probleem met de systeemtaal zh-CN voorkomt dat spraakopdrachten een mixed reality maken of het IP-adres van het apparaat weergeven.
