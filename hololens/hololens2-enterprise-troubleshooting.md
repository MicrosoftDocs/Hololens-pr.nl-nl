...
3. Als het ondernemingsprofiel is ingericht via Wi-Fi inrichtingspakket, kunt u overwegen het inrichtingspakket toe te passen op een Windows 10 pc. Als dit ook mislukt op Windows 10 pc, volgt u de probleemoplossingsgids Windows client 802.1X-verificatie.
...
1. Zorg ervoor dat Wi-Fi is ingeschakeld. Als u dit wilt controleren, gebruikt u de beweging Start en selecteert u Instellingen > Network & Internet > Wi-Fi. Als Wi-Fi is aan, probeert u deze uit te schakelen en vervolgens weer aan.
...
1. Op uw pc: configureer Fiddler zodat externe computers verbinding kunnen maken.
    ...
    1. Let op de luisterpoort voor Fiddler (standaard is dit 8866)
...
Wireshark is een netwerkprotocolanalyse en wordt gebruikt om TCP/UDP-verkeer van en naar uw HoloLens 2 controleren. Zo kunt u eenvoudig bepalen welk verkeer uw netwerk doorkruist naar uw HoloLens 2, hoeveel ervan, hoe vaak, hoeveel latentie er is tussen bepaalde hops, enzovoort.
...
Nee. U moet Azure Active Directory (Azure AD) gebruiken om gebruikersaccounts voor HoloLens beheren.
